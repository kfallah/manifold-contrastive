...
parser.add_argument("--dataset", type=str, default="stl10", help="Dataset to use")
parser.add_argument("--labels_per_class", type=int, default=50, help="Labels per class") 
parser.add_argument("--seed", type=int, default=0, help="Number of trials to run") 
...
parser.add_argument("--bsl", type=int, default=64, help="Labeled batchsize")
parser.add_argument("--bsu", type=int, default=448, help="Unlabeled batchsize")
...
parser.add_argument("--enable_transop", default=False, action='store_true', help="Whether to use transop model")
parser.add_argument("--transop_aug", default=False, action='store_true', help="Whether to apply transop prior augs")
...
if args.dataset == 'stl10':
    # ManifoldCLR
    ckpt_path = "/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/results/stl10_vi-thresh_proj/model_weight.pt"
    cfg_path = "/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/results/stl10_vi-thresh_proj/config.yaml"
else:
    ## CIFAR10 ##
    ckpt_path = "/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/results/cifar10_vi-thresh_proj/model_weight.pt"
    cfg_path = "/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/results/cifar10_vi-thresh_proj/config.yaml"
...
model = Model.initialize_model(cfg.model_cfg, cfg.dataloader_cfg.dataset_cfg.dataset_name, [0])
...
cfg.dataloader_cfg.dataset_cfg.dataset_dir = "/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/datasets"
# Load dataloaders
...
for exp_iter in range(args.n_trials):
    ...
    for _, data in enumerate(ssl_dataloader):
        ...
        # Full Eval
        if curr_iter % 2500 == 0 or (curr_iter+1) == args.n_iters:
            backbone.eval()
            backbone_ema.eval()
            correct = 0
            total = 0
