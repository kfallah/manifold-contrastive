...
root_dir = '/storage/home/hcoda1/0/kfallah3/p-crozell3-0/manifold-contrastive/'
...
# Load config
cfg = omegaconf.OmegaConf.load(root_dir + cfg_path)
...
state_dict = torch.load(root_dir + ckpt_path, map_location=default_device)
model.load_state_dict(state_dict['model_state'], strict=False)
# Manually override directory for dataloaders
if "tin" in ckpt_path:
    cfg.dataloader_cfg.dataset_cfg.dataset_dir = root_dir + "datasets/tiny-imagenet-200"
else:
    cfg.dataloader_cfg.dataset_cfg.dataset_dir = root_dir + "datasets"
